<script setup></script>
  ...
  <template>
    ...
    <div class="flex items-center justify-end mt-4">
      ...
      <div class="relative flex items-center w-2/5 ml-4 mr-14">
        <svg
        ...
        />
        <svg
          class="h-5 w-5 text-gray-400 absolute right-9"
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
          viewBox="0 0 256 256"
      ...
      <div class="flex ml-96">
        <svg
          class="h-8 w-7 m-3 text-gray-500"
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
          viewBox="0 0 24 24"
    ...
    <div class="flex flex-wrap m-6 ml-52">
      <a class="mr-3 text-blue-500" href="">All</a>
      <a class="mr-3" href="">Images</a>
      <a class="mr-3" href="">Videos</a>
      <a class="mr-3" href="">Books</a>
      <a class="mr-3" href="">News</a>
      <a class="mr-3" href="">more</a>
    </div>
     <!-- horizontal lines -->
